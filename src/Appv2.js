        ...
        <div className="rating">
          {!isWatched ?
            <>
              ...
              />
              {userRating > 0 && <button className="btn btn-add" onClick={handleAdd}>+ Add to list</button>}</>
            :
...
function WatchedSummary({ watched }) {
  ...
  const avgUserRating = average(watched.map((movie) => movie.userRating)).toFixed(0 || 1);
